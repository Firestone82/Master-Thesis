...
Dalším významným omezením je probíhající migrace frontendové části systému ze frameworku Svelte na framework Vue jak již bylo zmíněno v \secref[sekci]{subsec:kelvin-frontend}.
