...
První skupinu tvoří modely, které byly od počátku navrženy nebo dodatečně dotrénované (fine-tuned) specificky pro práci se zdrojovým kódem.
...
\begin{itemize}
    ...
    Na benchmarku HumanEval dosahuje varianta 34B přibližně 48\,\% úspěšnosti (pass@1).
    ...
    \item \textbf{StarCoder~2}~\cite{starcoder2} vznikl v rámci projektu BigCode jako plně otevřený model trénovaný na datové sadě The Stack~v2 o rozsahu 3,3 bilionu tokenů.
    Je k dispozici ve velikostech 3B, 7B a 15B parametrů.
    Největší varianta dosahuje na HumanEval přibližně 46\,\% úspěšnosti.
    Výhodou StarCoderu~2 je transparentnost trénovaných dat, vývojáři mohou ověřit, zda byl jejich kód použit pro trénování, případně požádat o jeho vyřazení.
