...
Pro ilustraci reálných nákladů lze uvést příklad předmětu UPR (Úvod do programování), kde přibližně 500 studentů odevzdá v průměru 10 úloh za semestr (celkem 5~000 odevzdání).
Při použití modelu GPT-5.4-nano s zero-shot přístupem by celkové náklady za semestr dosáhly přibližně \$5, zatímco u modelu střední třídy, jako je Claude~3.5 Haiku s chain-of-thought přístupem, by vzrostly na přibližně \$150.
Přesné náklady bude však možné stanovit až na základě pilotního nasazení a vyhodnocení skutečných statistik provozu.
