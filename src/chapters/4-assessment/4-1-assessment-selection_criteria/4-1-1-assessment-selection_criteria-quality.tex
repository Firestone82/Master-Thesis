...
\begin{itemize}
    ...
    \item \textbf{Relevance k zadání} -- model by měl posuzovat řešení s ohledem na konkrétní zadání úlohy, nikoli pouze na obecné programátorské principy.
    ...
    Absolutní reprodukovatelnost \textbf{není} u pravděpodobnostních systémů realistická, ale výstupy by se neměly mezi dvěma identickými odevzdáními zásadně lišit.
\end{itemize}

Pro objektivní porovnání kvality modelů existují standardizované benchmarky -- soubory testovacích úloh sloužící k měření výkonu systému za definovaných podmínek.
V oblasti práce se zdrojovým kódem jsou nejznámější:
...
Pro hodnocení kvality výstupů v kontextu Kelvinu byly proto zvoleny dvě vlastní metriky, které lépe odpovídají požadavkům na analýzu studentských řešení:
