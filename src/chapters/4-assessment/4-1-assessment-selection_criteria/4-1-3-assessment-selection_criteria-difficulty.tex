...
U on-premise nasazení jsou náklady primárně jednorázové -- zahrnují pořízení hardwaru, především grafických karet s dostatečnou kapacitou VRAM pro inferenci (viz \secref{subsec:llm-computational-cost}).
