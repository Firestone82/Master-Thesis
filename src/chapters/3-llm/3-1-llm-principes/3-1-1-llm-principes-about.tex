...
Formálně se model snaží odhadnout podmíněnou pravděpodobnost: $P(x_t \mid x_1, x_2, \ldots, x_{t-1}), \label{eq:llm-probability}$
...
Negeneruje důkaz správnosti programu, nespouští kód a nevytváří abstraktní syntaktický strom (AST) v klasickém slova smyslu.
