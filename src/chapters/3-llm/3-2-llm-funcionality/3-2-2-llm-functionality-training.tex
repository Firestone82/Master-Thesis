...
Trénovací data jsou nejprve tokenizována, tedy převedena na sekvence celočíselných identifikátorů odpovídajících jednotlivým slovním jednotkám nebo jejich částem (viz \secref{subsubsec:tokenization}).
...
\begin{figure}[ht]
    ...
    \caption{Schéma celého procesu od trénování po nasazení LLM\@. Předtrénování na rozsáhlých datech vytvoří základní model, instrukční dolaďování jej naučí sledovat pokyny a RLHF optimalizuje kvalitu výstupů na základě lidských preferencí. Finální model je poté nasazen pro inferenci.}
