...
V posledních letech se jako potenciální podpůrný nástroj ukazují velké jazykové modely (LLM), které dokáží řešit zadání, analyzovat zdrojový kód, identifikovat problematická místa a generovat strukturované komentáře v přirozeném jazyce.
