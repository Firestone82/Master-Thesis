...
Nevýhodou je nutnost zajistit dostatečný hardware -- zejména grafické akcelerátory (GPU) s dostatečnou kapacitou VRAM -- a technickou odbornost pro správu a údržbu systému.

Pro usnadnění nasazení jazykových modelů v lokálním prostředí existuje několik softwarových nástrojů:
...
\begin{itemize}
    ...
    Vhodná pro prostředí s vyšší zátěží.
...
Odezva na GPU je tak srovnatelná s komerčními cloudovými API, zatímco čistě CPU inference je pro interaktivní použití obtížně přijatelná.
...
Neexistuje třetí strana, které by musela být svěřena správa dat, a není potřeba uzavírat smlouvu o zpracování osobních údajů (DPA) s externím poskytovatelem.
...
Naopak pro systém se stovkami studentů zpracovávajícími tisíce odevzdání ročně se investice do vlastního hardwaru může vrátit v horizontu jednoho až dvou let.
