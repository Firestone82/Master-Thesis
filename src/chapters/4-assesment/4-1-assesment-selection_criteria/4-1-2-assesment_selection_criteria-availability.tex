...
\begin{itemize}
    ...
    \item \textbf{Geografická dostupnost a datová centra} -- jak bylo zmíněno v \secref[Sekci]{subsubsec:gdpr-data-transfer} o ochraně osobních údajů, je důležité, aby poskytovatel modelu měl datová centra v regionech, které jsou v souladu s GDPR, pokud budou zpracovávána data studentů z EU\@.
