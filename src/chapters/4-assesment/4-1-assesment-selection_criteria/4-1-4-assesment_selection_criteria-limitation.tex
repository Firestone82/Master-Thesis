...
Aby byl systém schopen zvládnout i rozsáhlejší úlohy (větší projekty, více souborová řešení) a aby byl respektován princip dostatečné rezervy, je jako \textbf{minimální požadavek} stanoveno \textbf{16~000 tokenů}.
