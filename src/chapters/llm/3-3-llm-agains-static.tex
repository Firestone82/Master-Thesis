...
Výsledkem je deterministická analýza, kde při identickém vstupu nástroj vždy poskytne identický výstup, nezávisle na jakémkoli náhodném prvku.
...
Někteří autoři a správci open-source projektů přitom výslovně nepřejí, aby byl jejich kód pro trénování jazykových modelů využíván, a existují iniciativy jako BigCode projekt umožňující vývojářům z trénovacích dat svůj kód odstranit~\cite{kocetkov-stack}.
