...
\begin{enumerate}
    ...
    Kompilátory jako GCC nebo Clang generují při překladu varování na potenciálně problematické konstrukce.
    ...
    SonarQube kombinuje statickou analýzu s průběžným sledováním trendů kvality kódu, tzv.\ \textit{technical debt} a umožňuje nastavovat prahy kvality (quality gates) blokující nasazení kódu, který nesplňuje definovaná kritéria.
