...
V rámci Evropské unie je při zpracování osobních údajů třetí stranou zpravidla nutné uzavřít smlouvu o zpracování osobních údajů (Data Processing Agreement)~\cite{nist-airmf}.
...
Prompt injection je specifická třída bezpečnostních útoků cílená na systémy postavené na LLM\cite{owasp-promptinjection}.
