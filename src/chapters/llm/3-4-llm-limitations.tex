...
Otázkou osobních údajů ve zdrojovém kódu se zabývá i odborná literatura~\cite{kochetkov-code}.
...
V~opačném případě je nutné uzavřít smlouvu o zpracování osobních údajů (Data Processing Agreement)~\footnote{https://gdpr.eu/what-is-data-processing-agreement/} a posoudit podmínky konkrétní služby, zejména zda poskytovatel data uchovává nebo využívá pro další trénování modelu.
