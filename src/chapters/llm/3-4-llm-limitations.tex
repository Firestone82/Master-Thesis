...
Nařízení GDPR (General Data Protection Regulation) klasifikuje studentské záznamy spjaté s identifikovatelnými osobami jako osobní údaje.
Jejich předání externímu poskytovateli cloudových služeb je právně přípustné, avšak vyžaduje splnění konkrétních podmínek.
