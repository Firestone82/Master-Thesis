...
Tato sekce systematicky rozebírá čtyři hlavní kategorie omezení: limit kontextového okna, výpočetní a provozní náročnost, paměťové nároky a otázky ochrany dat~\cite{ibm2024llmlimitations}.
...
V rámci Evropské unie je při zpracování osobních údajů třetí stranou zpravidla nutné uzavřít smlouvu o zpracování osobních údajů (Data Processing Agreement)~\cite{nist2023airmf}.
...
Prompt injection je specifická třída bezpečnostních útoků cílená na systémy postavené na LLM~\cite{owasp2024promptinjection}.
