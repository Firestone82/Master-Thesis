...
Systém proto již disponuje samostatnou asynchronní post-procesní fází, která je spouštěna až po dokončení a zveřejnění výsledků testů – tento mechanismus je využíván například právě pro kontrolu plagiátorství.
Tato fáze je nezávislá na hlavní evaluační pipeline a neovlivňuje dobu odezvy systému z pohledu studenta.
Stejný princip lze využít i pro další rozšiřující moduly, aniž by byla narušena základní funkčnost a výkon již implementované evaluace.
