...
\begin{itemize}
    ...
    \item \textbf{Ohodnotit} (\textit{rate}) umožňuje učiteli poskytnout zpětnou vazbu o kvalitě a relevanci návrhu, přičemž hodnocení lze zada pouze před přijetím nebo zamítnutím.
    Podrobněji je systém hodnocení popsán níže.
\end{itemize}

Před publikací návrhu je vhodné, aby učitel zvážil jeho obsah a ohodnotil jej, protože navrhované komentáře mohou obsahovat nepřesnosti nebo být v daném kontextu zcela nevhodné.
...
Panel pro přijetí nebo zamítnutí návrhu včetně hodnocení kvality a relevance pomocí hvězdiček je zobrazen v pravém horním rohu komentáře na \figref[obrázku]{fig:frontend-comment}.
