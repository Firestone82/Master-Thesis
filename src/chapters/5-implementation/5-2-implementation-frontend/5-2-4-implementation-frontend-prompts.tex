...
Rozhraní (viz \figref{fig:frontend-prompts}) umožňuje učitelům vytvářet, prohlížet a editovat prompty přímo v prostředí systému Kelvin bez nutnosti zásahu do konfiguračních souborů nebo nasazení nové verze aplikace.
...
Pouze vlastník promptu nebo superadmin může jeho obsah upravovat, avšak všichni učitelé mohou libovolný prompt použít při konfiguraci analýzy svých úloh.
Tímto způsobem je zajištěno sdílení osvědčených promptů mezi učiteli při zachování kontroly nad jejich úpravami.
