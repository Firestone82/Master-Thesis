...
Administrátor může prohlížet zdrojové soubory jednotlivých odevzdání a ověřit, že vstupní data jsou kompletní a vhodná pro testování (\figref[příloha]{fig:analyzyer-sources}).
